...
public class TBGameMaskerTest extends MongoGameCoreTestCase {
    ...
    public void testMaskingGame() {
        ...
        assertEquals(playerState.getAlive(), maskedGame.getMaskedPlayersState().getAlive());
        assertEquals(playerState.getSetup(), maskedGame.getMaskedPlayersState().getSetup());
