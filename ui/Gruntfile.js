...
module.exports = function (grunt) {
            ...
            development: {
                constants: {
                    ENV: {
                        name: 'development',
                        domain: 'localhost',
                        apiEndpointAndroidEmulator: 'http://10.0.2.2:8080',
                        apiEndpointGeny: 'http://192.168.56.1:8080',
        ...
        karma: {
            options: {
                ...
                files: [
                    ...
                    '<%= yeoman.app %>/<%= yeoman.scripts %>/controllers/controllers.js',
                    '<%= yeoman.app %>/bower_components/angular-cookies/angular-cookies.js',
                    '<%= yeoman.app %>/bower_components/angular-resource/angular-resource.js',
                    '<%= yeoman.app %>/bower_components/jtb-core-games-ui/dist/core-games-ui.js',
                    '<%= yeoman.app %>/bower_components/jtb-core-games-ionic-ui/dist/core-games-ionic-ui.js',
                    ...
                    '<%= yeoman.app %>/bower_components/angular-multi-select-alexandernst/dist/angular-multi-select.js',
    ...
    grunt.registerTask('ripple', ['ngconstant:development', 'wiredep', 'newer:copy:app', 'prepare', 'ripple-emulator']);
